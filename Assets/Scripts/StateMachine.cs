...
// 元のコード
// https://github.com/ina-amagami/unity-csharp-design-patterns/blob/master/StateMachine/StateMachine.cs
...
public class StateMachine<TOwner>
{
    ...
    public event Action<State> OnEnterState = _ => { };
    ...
    {
        var state = GetOrAddState<TFirst>();
        Start(state);
        OnEnterState(state);
    }
